    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-header">
                ...
                <h3 class=""> <strong><b>Sertifikat Peserta</b>
                    </strong></h3>
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(base_url('panitia/event/sertifikat')) ?>
                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img width="100%" src="<?php if ($event->sertifikat == "") {
                                                        echo base_url('assets/uploads/sertifikat/default.png');
                                                    } else {
                                                        echo base_url('assets/uploads/sertifikat/' . $event->sertifikat);
                                                    } ?>" alt="">
                        </div>
                    </div>
                    <br>
