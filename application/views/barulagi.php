...
<body>
    ...
    <script src="<?= base_url('assets/rakitan/') ?>assets/js/vendor/popper.min.js"></script>
    <script src="<?= base_url('assets/rakitan/') ?>dist/js/bootstrap.min.js"></script>
    <script src="<?= base_url('assets/rakitan/') ?>assets/js/vendor/holder.min.js"></script>
    <script>
